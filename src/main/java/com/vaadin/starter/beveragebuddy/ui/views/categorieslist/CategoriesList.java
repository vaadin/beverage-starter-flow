...
import com.vaadin.starter.beveragebuddy.ui.common.AbstractEditorDialog.DialogOperation;
import com.vaadin.starter.beveragebuddy.ui.common.AbstractEditorDialog.Operation;
...
public class CategoriesList extends VerticalLayout {
    ...
    private static class DisabledEdit implements Operation {

        @Override
        public String getNameInTitle() {
            return DialogOperation.EDIT.getNameInTitle();
        }

        @Override
        public String getNameInText() {
            return DialogOperation.EDIT.getNameInText();
        }
    ...
    private Button createEditButton(Category category) {
        Operation operation = "Undefined".equals(category.getName())
                ? new DisabledEdit()
                : AbstractEditorDialog.DialogOperation.EDIT;
        Button edit = new Button("Edit",
                event -> form.open(category, operation));
